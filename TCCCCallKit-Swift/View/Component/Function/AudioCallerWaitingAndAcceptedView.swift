...
class AudioCallerWaitingAndAcceptedView : UIView {
    ...
    lazy var muteMicBtn: BaseControlButton = {
        ...
        muteAudioBtn.updateTitleColor(titleColor: UIColor.t_colorWithHexString(color: "#000000"))
        return muteAudioBtn
    }()
    ...
    lazy var hangupBtn: BaseControlButton = {
        ...
        hangupBtn.updateTitleColor(titleColor: UIColor.t_colorWithHexString(color: "#000000"))
        return hangupBtn
    }()
    ...
    lazy var changeSpeakerBtn: BaseControlButton = {
        ...
        changeSpeakerBtn.updateTitleColor(titleColor: UIColor.t_colorWithHexString(color: "#000000"))
