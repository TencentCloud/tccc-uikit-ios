...
typedef NS_ENUM(NSInteger, TCCCErrorCode) {
  /////////////////////////////////////////////////////////////////////////////////
  //
  //       基础错误码
  //
  ...
  /// 你调用该接口超过频率的限制，或者是上次调用还没完成又调用了该接口
  ERR_HAD_OVERLIMIT = -10006,
...
typedef NS_ENUM(NSInteger, TCCCCWarningCode) {
  /////////////////////////////////////////////////////////////////////////////////
  //
  //       基础警告码
  //
  ...
  /////////////////////////////////////////////////////////////////////////////////
  /// 上一通会话还没结束，新的会话进来了
  WARNING_LAST_CALL_NO_OVER = 90001,
